...
<div class="col-lg-12">
  ...
  <div class="row">
    <div class="col-lg-3">
      <a href="/monitoring/home"  class="btn btn-primary" name="button">All</a>
      <a href="/monitoring/home?param={{urlencode('With Sticker')}}" class="btn btn-primary" name="button">With Sticker</a>
      <a href="/monitoring/home?param={{urlencode('Without Sticker')}}"  class="btn btn-primary" name="button">Without Sticker</a>
    </div>
  </div>
  <!-- <center style="margin-bottom: -20px"> -->
    ...
    <!-- <select class="form-control" onchange="if (this.value) window.location.href=this.value" id="filterSelect">
      <option value="/monitoring/home" style="display:none;">{{ app('request')->input('param') !== null ? app('request')->input('param')  : 'All'}}</option>
      <option value="/monitoring/home">All</option>
      <option value="/monitoring/home?param={{urlencode('With Sticker')}}">With Sticker</option>
      <option value="/monitoring/home?param={{urlencode('Without Sticker')}}">Without Sticker</option>
    </select> -->
  <!-- </center> -->
    <div class="row">
      <div class="col-lg-12">
