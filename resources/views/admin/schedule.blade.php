...
<div class="modal fade" id="edit-gate" tabindex="-1" role="dialog" aria-labelledby="edit-gate" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
...
<div class="modal fade" id="edit-monitoring" tabindex="-1" role="dialog" aria-labelledby="edit-monitoring" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    {{Form::open(['url'=>'admin/edit-sched','method'=>'post'])}}
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="monitoring">Edit Schedule</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
