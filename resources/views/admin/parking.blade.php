                        ...
                        <div class="btn-group show-on-hover">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            ...
                            {{Form::open(['url'=>'admin/delete-parking','method'=>'post','onsubmit'=>'return confirm("Are you sure you want to delete this slot?")'])}}
                              <button style="display: flex;-webkit-appearance: caret;padding: 3px 20px;color:#333;background:none;font-weight:normal" type="submit" name="id" value="{{$value->id}}">Delete</button>
                            {{Form::close()}}
                          </li>
                          </ul>
                        </div>
